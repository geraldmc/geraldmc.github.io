...
Two things to notice: my car appears twice in the image - once in the upper-left and again in the middle-right portion. Because the area was too long (1200ft) to be covered in a single flight it had to be flown twice each capture - once for the left half and once for the right. I would set up on one side, fly the mission over half the field, then pack everything up drive to the far side and fly the other. Consumer drones use their battery power way too fast!
