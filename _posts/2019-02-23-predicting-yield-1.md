...
Before moving on to the next post I show an image of a single treated section. After going to the trouble of accurately stitching together hundreds of images we cut that larger up precisely into smaller samples. The section above represents a single treatment gathered on a specific day during the sugarcane growing season from late April to mid-November. Ultimately more than a dozen useable samples per treatment from this field were captured, each spaced as evenly as weather conditions permitted starting from one week prior to fertilizing up to 4 days before the field was harvested.